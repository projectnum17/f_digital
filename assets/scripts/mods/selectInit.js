    ...
    const lightweightDropdown = (selectEl) => {
        ...
        const updateSelection = (value, text) => {
            ...
            if (value === '' || value === null) {
                ...
                styledSelect.classList.add('selected'); // добавляем класс при выборе
            }
